...
class App extends React.Component {
    state = {
        ...
        datos: [
            {nombre: 'Alfonso', apellidos: 'Izquierdo', fecha: new Date('1971-11-27'), sexo: 'Hombre', tiempo_parcial: true},
            {nombre: 'Macarena', apellidos: 'Díez', fecha: new Date('1993-3-28'), sexo: 'Mujer', tiempo_parcial: false},
        ]
    }
